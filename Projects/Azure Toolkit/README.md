...
## 🔧 Key Features
- 📊 **Cost Breakdown**: Generate and view visual summaries of client-specific Azure usage over time.
- 🧠 **Saved Queries and Alerts**: Users can create and save queries with automated alerts.
...
- ⏱️ **Query Execution**: Ability to run queries immediately.
...
- **External Services**: Azure SDK, PyInstaller (for packaging)
